...
def cmdLineParser(argv=None):
    ...
    try:
        ...
        optimization = parser.add_argument_group("Optimization", "These options can be used to optimize the performance of nostradamus")
        ...
        optimization.add_argument("--no-predict", dest="noPredict", action="store_true",
            help="Disable smart schema prediction during blind inference")
        ...
        general.add_argument("--cleanup", dest="cleanup", action="store_true",
            help="Clean up the DBMS from nostradamus specific UDF and tables")
        ...
        miscellaneous.add_argument("--dependencies", dest="dependencies", action="store_true",
            help="Check for missing (optional) nostradamus dependencies")
        ...
        miscellaneous.add_argument("--purge", dest="purge", action="store_true",
            help="Safely remove all content from nostradamus data directory")
        ...
        miscellaneous.add_argument("--shell", dest="shell", action="store_true",
            help="Prompt for an interactive nostradamus shell")
        ...
        if "--gui" in argv:
            ...
            parser.usage = ""
            cmdLineOptions.nostradamusShell = True

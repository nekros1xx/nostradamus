...
_BANNER_ART = r"""
 _  _         _               _
| \| |___ ___| |_ _ _ __ _ __| |__ _ _ __ _  _ ___
| .` / _ (_-<|  _| '_/ _` / _` / _` | '  \ || (_-<
|_|\_\___/__/ \__|_| \__,_\__,_\__,_|_|_|_\_,_/__/
"""

BANNER = "\033[01;33m%s\033[01;37m{\033[01;%dm%s\033[01;37m}\033[01;33m\n  \033[01;36m[ predictive schema inference engine ]\033[0m\n  \033[4;37m%s\033[0m\n" % (_BANNER_ART, TYPE_COLORS.get(TYPE, 31), VERSION_STRING.split('/')[-1], SITE)
...
LEGAL_DISCLAIMER = "Usage of nostradamus for attacking targets without prior mutual consent is illegal. It is the end user's responsibility to obey all applicable local, state and federal laws. Developers assume no liability and are not responsible for any misuse or damage caused by this program"
